...
// Which stored snapshot answers a league's ADP question, and what a board row
// looks like — shared with War Room's cheat sheet so both read the same board.
...
const { resolveKey, snapshotRows } = latest;
